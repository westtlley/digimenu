...
export async function createCardapioOrder(orderData, slug) {
  ...
  const finalOrderData = normalizeOrderForPersistence({
    ...
    delivery_radius_km_limit: Number.isFinite(deliveryContext.deliveryRadiusKmLimit) ? deliveryContext.deliveryRadiusKmLimit : null,
    delivery_radius_result: deliveryContext.deliveryRadiusResult || null,
    delivery_radius_behavior_applied: deliveryContext.deliveryRadiusBehaviorApplied || null,

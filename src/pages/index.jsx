...
import { loadAdminPage, loadPainelAssinantePage, loadColaboradorHomePage } from './protectedRouteLoaders';
...
const ColaboradorHome = lazy(loadColaboradorHomePage);
...
const PainelAssinante = lazy(loadPainelAssinantePage);
